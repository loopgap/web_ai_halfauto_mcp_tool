...
import { Skill, SkillInput, QualityGate, SkillFallback } from "../types";
        ...
        <div className="flex items-center gap-2">
          {skill.dispatch?.prefer_providers && (
            <div className="flex gap-1.5">
              {skill.dispatch.prefer_providers.map((p: string) => (
        ...
        <div className="px-5 pb-5 border-t border-white/[0.06] pt-4 space-y-4">
          {skill.intent_tags.length > 0 && (
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {skill.intent_tags.map((t: string) => (
          ...
          {Object.keys(skill.inputs).length > 0 && (
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {Object.entries(skill.inputs).map(([key, input]: [string, SkillInput]) => (
          ...
          {skill.quality_gates.length > 0 && (
            <div>
              ...
              <div className="space-y-1">
                {skill.quality_gates.map((g: QualityGate, i: number) => (
          ...
          {skill.fallbacks.length > 0 && (
            <div>
              ...
              {skill.fallbacks.map((f: SkillFallback, i: number) => (
                <div key={i} className="px-3.5 py-2.5 inner-panel rounded-xl text-xs text-slate-400">
